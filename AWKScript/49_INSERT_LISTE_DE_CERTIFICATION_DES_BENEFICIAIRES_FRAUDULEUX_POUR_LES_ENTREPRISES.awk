#!/usr/bin/gawk -f
# 49_INSERT_LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES.awk
# gawk -f AWKScript/49_INSERT_LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES.awk
...

{
	if(FNR == 1 || LeSerrageBit == 1){
		...
		print "INSERT INTO";
		print "	LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES";
...
function Boucle500_LeSerrage(){
	...
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES.NUMERO_DE_SEQUENCE AS NUMERO_DE_SEQUENCE_CH,";
	...
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES";
	print "	ON";
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES.NUMERO_DE_SEQUENCE = PREQUEL_UNE.NUMERO_DE_SEQUENCE";
	print ")";
	print "SELECT";
