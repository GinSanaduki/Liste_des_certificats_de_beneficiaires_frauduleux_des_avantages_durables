...
function InitConst(){
	...
	GrepCmd_ExistCheck_Kojin = "grep  -a -F -q \047"SearchTargetText_Kojin"\047";
	GrepCmd_ExistCheck_Houjin = "grep  -a -F -q \047"SearchTargetText_Houjin"\047";
	GrepCmd_Component_Kojin = "grep  -a -F \047"SearchTargetText_Kojin"\047";
	GrepCmd_Component_Houjin = "grep  -a -F \047"SearchTargetText_Houjin"\047";
...
function InitConst_Deux(){
	MainURL = "https://www.meti.go.jp/covid-19/yachin-kyufu/fusei_nintei.html";
	GawkCommand_05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Page_d_accueil = "gawk -f AWKScript/05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Page_d_accueil.awk SQLScript/07_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Page_d_accueil_PRESTATIONS_D_AIDE_AU_LOYER.sql > ";
	MkdirCmd_TempSQLScripts = "mkdir \042TempSQLScripts\042 > /dev/null 2>&1";
	MkdirCmd_StoredHTML = "mkdir \042StoredHTML\042 > /dev/null 2>&1";
	MkdirCmd_SQLITE3 = "mkdir \042SQLITE3\042 > /dev/null 2>&1";
	SQLite3Cmd_RENSEIGNEMENTS_SUR_LE_SITE = "sqlite3 SQLITE3/RENSEIGNEMENTS_SUR_LE_SITE.sqlite3 < ";
	SearchTargetText_Kojin = "個人事業主　家賃支援給付金不正受給者認定一覧（PDF形式：";
	SearchTargetText_Houjin = "法人　家賃支援給付金不正受給者認定一覧（PDF形式：";
	GrepCmd_ExistCheck_Kojin = "grep  -a -F -q \047"SearchTargetText_Kojin"\047";
	GrepCmd_ExistCheck_Houjin = "grep  -a -F -q \047"SearchTargetText_Houjin"\047";
	GrepCmd_Component_Kojin = "grep  -a -F \047"SearchTargetText_Kojin"\047";
	GrepCmd_Component_Houjin = "grep  -a -F \047"SearchTargetText_Houjin"\047";
	ComponentURL_Main = "https://www.meti.go.jp";
	DownLoadPDFName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "個人事業主_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD".pdf";
	PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "個人事業主_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD".txt";
	Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "個人事業主_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD"_Edited.tsv";
	Registed_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "08_個人事業主_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD"_Registed.sql";
	TSV_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "個人事業主_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD".tsv";
	
	GawkCommand_05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "gawk -f AWKScript/05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Page_d_accueil.awk SQLScript/11_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants_PRESTATIONS_D_AIDE_AU_LOYER.sql > ";
	DownLoadPDFName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "法人_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD".pdf";
	PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "法人_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD".txt";
	Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "法人_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD"_Edited.tsv";
	Registed_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "09_家賃支援給付金不正受給者認定一覧_"STRFTIME_YYYYMMDD"_Registed.sql";
	GawkCommand_05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "gawk -f AWKScript/05_Gsub_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Page_d_accueil.awk SQLScript/12_INSERT_RENSEIGNEMENTS_SUR_LE_SITE_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises_PRESTATIONS_D_AIDE_AU_LOYER.sql > ";
	PDFToTextCmd_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "pdftotext \042StoredHTML/"DownLoadPDFName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042 \042StoredHTML/"PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042";
	PDFToTextCmd_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "pdftotext \042StoredHTML/"DownLoadPDFName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042 \042StoredHTML/"PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042";
	EditCmd_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants = "sh ShellScript/06_EditTemplate_PRESTATIONS_D_AIDE_AU_LOYER.sh \042StoredHTML/"PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042 \042StoredHTML/"Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042";
	EditCmd_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises = "sh ShellScript/08_EditTemplate_PRESTATIONS_D_AIDE_AU_LOYER_Les_Enterprises.sh \042StoredHTML/"PDFToText_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042 \042StoredHTML/"Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042";
	RegistCmd = "sh ShellScript/07_Regist_PRESTATIONS_D_AIDE_AU_LOYER.sh \042StoredHTML/"Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042 \042TempSQLScripts/"Registed_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_travailleurs_independants"\042 \042StoredHTML/"Edited_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042 \042TempSQLScripts/"Registed_OutputFileName_Liste_de_certification_des_beneficiaires_frauduleux_pour_les_Entreprises"\042";
}
