#!/usr/bin/gawk -f
# 54_INSERT_LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER.awk
# gawk -f AWKScript/54_INSERT_LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER.awk
...

{
	if(FNR == 1 || LeSerrageBit == 1){
		...
		print "INSERT INTO";
		print "	LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER";
	...
	if($4 == ""){
		...
		print "		\047"$4"\047 AS NOM_DE_LA_PERSONNE_CERTIFIEE_LES_ENTREPRISES,";
	}
	
	if($5 == ""){
		print "		NULL AS NOM_DE_LA_PERSONNE_CERTIFIEE,";
	} else {
		print "		\047"$5"\047 AS NOM_DE_LA_PERSONNE_CERTIFIEE,";
	}
	
	if($6 == ""){
		print "		NULL AS EMPLACEMENT,";
	} else {
		print "		\047"$6"\047 AS EMPLACEMENT,";
	}
	
	print "		"$7" AS SOMME_D_ARGENT,";
	print "		\047"$8"\047 AS APERCU";
...
function Boucle500_LeSerrage(){
	...
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER.NUMERO_DE_SEQUENCE AS NUMERO_DE_SEQUENCE_CH,";
	...
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER";
	print "	ON";
	print "		LISTE_DE_CERTIFICATION_DES_BENEFICIAIRES_FRAUDULEUX_POUR_LES_ENTREPRISES_PRESTATIONS_D_AIDE_AU_LOYER.NUMERO_DE_SEQUENCE = PREQUEL_UNE.NUMERO_DE_SEQUENCE";
	print ")";
	print "SELECT";
