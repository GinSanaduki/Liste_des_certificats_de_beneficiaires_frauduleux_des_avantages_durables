#!/usr/bin/gawk -f
# 56_EditComponent_PRESTATIONS_D_AIDE_AU_LOYER_Deux_Les_Enterprises.awk
...

{
	...
	delete arrays;
	print $1"\t"$2"\t"Converted_YYYYMMDD"\t"Cols3"\t"Cols4"\t"Cols5"\t"Amount"\t"Issue;
}
